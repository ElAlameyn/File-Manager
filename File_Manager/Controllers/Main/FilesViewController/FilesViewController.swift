...
class FilesViewController: UIViewController {
  ...
  private func update(files: [ListFoldersResponse.File]?, updateLastModified: Bool? = false) {
    ...
    filesViewModel.filteredByDateModified().forEach {
